...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a70:	68 c0 1e 80 00       	push   $0x801ec0
  ...
  800a90:	68 c0 1e 80 00       	push   $0x801ec0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b73:	68 d7 1e 80 00       	push   $0x801ed7
  800b78:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c23:	50                   	push   %eax
  800c24:	56                   	push   %esi
  800c25:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ec7:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801056:	56                   	push   %esi
  801057:	50                   	push   %eax
  801058:	68 04 1f 80 00       	push   $0x801f04
  ...
  801069:	e8 54 00 00 00       	call   8010c2 <vcprintf>
	cprintf("\n");
  80106e:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011c1:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  8011c8:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80138c:	50                   	push   %eax
  80138d:	68 3f 1f 80 00       	push   $0x801f3f
  801392:	53                   	push   %ebx
  801393:	56                   	push   %esi
  ...
  8013a4:	52                   	push   %edx
  8013a5:	68 bd 1e 80 00       	push   $0x801ebd
  8013aa:	53                   	push   %ebx
  8013ab:	56                   	push   %esi
  ...
  8013c9:	b8 38 1f 80 00       	mov    $0x801f38,%eax
