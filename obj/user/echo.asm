  ...
  80006f:	83 c6 04             	add    $0x4,%esi
{
  ...
  80008a:	68 ce 22 80 00       	push   $0x8022ce
  ...
  8000c7:	68 8f 1f 80 00       	push   $0x801f8f
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800523:	68 8d 1e 80 00       	push   $0x801e8d
  800528:	6a 23                	push   $0x23
  80052a:	68 aa 1e 80 00       	push   $0x801eaa
  80052f:	e8 1a 0f 00 00       	call   80144e <_panic>
...
//	panic("SYSCALL: %d\n",a1);
  ...
  8005a4:	68 8d 1e 80 00       	push   $0x801e8d
  8005a9:	6a 23                	push   $0x23
  8005ab:	68 aa 1e 80 00       	push   $0x801eaa
  8005b0:	e8 99 0e 00 00       	call   80144e <_panic>
...
//	panic("SYSCALL: %d\n",a1);
  ...
  8005e6:	68 8d 1e 80 00       	push   $0x801e8d
  8005eb:	6a 23                	push   $0x23
  8005ed:	68 aa 1e 80 00       	push   $0x801eaa
  8005f2:	e8 57 0e 00 00       	call   80144e <_panic>
int
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800628:	68 8d 1e 80 00       	push   $0x801e8d
  80062d:	6a 23                	push   $0x23
  80062f:	68 aa 1e 80 00       	push   $0x801eaa
  800634:	e8 15 0e 00 00       	call   80144e <_panic>
int
sys_page_unmap(envid_t envid, void *va)
{
...
//	panic("SYSCALL: %d\n",a1);
  ...
  80066a:	68 8d 1e 80 00       	push   $0x801e8d
  80066f:	6a 23                	push   $0x23
  800671:	68 aa 1e 80 00       	push   $0x801eaa
  800676:	e8 d3 0d 00 00       	call   80144e <_panic>
...
//	panic("SYSCALL: %d\n",a1);
  ...
  8006ac:	68 8d 1e 80 00       	push   $0x801e8d
  8006b1:	6a 23                	push   $0x23
  8006b3:	68 aa 1e 80 00       	push   $0x801eaa
  8006b8:	e8 91 0d 00 00       	call   80144e <_panic>
...
//	panic("SYSCALL: %d\n",a1);
  ...
  8006ee:	68 8d 1e 80 00       	push   $0x801e8d
  8006f3:	6a 23                	push   $0x23
  8006f5:	68 aa 1e 80 00       	push   $0x801eaa
  8006fa:	e8 4f 0d 00 00       	call   80144e <_panic>
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800752:	68 8d 1e 80 00       	push   $0x801e8d
  800757:	6a 23                	push   $0x23
  800759:	68 aa 1e 80 00       	push   $0x801eaa
  80075e:	e8 eb 0c 00 00       	call   80144e <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800840:	ba 34 1f 80 00       	mov    $0x801f34,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80086b:	51                   	push   %ecx
  80086c:	50                   	push   %eax
  80086d:	68 b8 1e 80 00       	push   $0x801eb8
  800872:	e8 b0 0c 00 00       	call   801527 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800a95:	53                   	push   %ebx
  800a96:	50                   	push   %eax
  800a97:	68 f9 1e 80 00       	push   $0x801ef9
  800a9c:	e8 86 0a 00 00       	call   801527 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800b6a:	53                   	push   %ebx
  800b6b:	50                   	push   %eax
  800b6c:	68 15 1f 80 00       	push   $0x801f15
  800b71:	e8 b1 09 00 00       	call   801527 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800c1f:	53                   	push   %ebx
  800c20:	50                   	push   %eax
  800c21:	68 d8 1e 80 00       	push   $0x801ed8
  800c26:	e8 fc 08 00 00       	call   801527 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
stat(const char *path, struct Stat *stat)
{
  ...
  800cea:	e8 dc 01 00 00       	call   800ecb <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  800d31:	e8 27 0e 00 00       	call   801b5d <ipc_find_env>
  ...
  800d4c:	e8 c9 0d 00 00       	call   801b1a <ipc_send>
  ...
  800d59:	e8 5f 0d 00 00       	call   801abd <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800e6f:	78 51                	js     800ec2 <devfile_read+0x7f>
		return r;
	assert(r <= n);
  800e71:	39 c6                	cmp    %eax,%esi
  800e73:	73 19                	jae    800e8e <devfile_read+0x4b>
  800e75:	68 44 1f 80 00       	push   $0x801f44
  800e7a:	68 4b 1f 80 00       	push   $0x801f4b
  800e7f:	68 80 00 00 00       	push   $0x80
  800e84:	68 60 1f 80 00       	push   $0x801f60
  800e89:	e8 c0 05 00 00       	call   80144e <_panic>
	assert(r <= PGSIZE);
  800e8e:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800e93:	7e 19                	jle    800eae <devfile_read+0x6b>
  800e95:	68 6b 1f 80 00       	push   $0x801f6b
  800e9a:	68 4b 1f 80 00       	push   $0x801f4b
  800e9f:	68 81 00 00 00       	push   $0x81
  800ea4:	68 60 1f 80 00       	push   $0x801f60
  800ea9:	e8 a0 05 00 00       	call   80144e <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  800eae:	83 ec 04             	sub    $0x4,%esp
  800eb1:	50                   	push   %eax
  800eb2:	68 00 50 80 00       	push   $0x805000
  800eb7:	ff 75 0c             	pushl  0xc(%ebp)
  800eba:	e8 4a f4 ff ff       	call   800309 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  800ed2:	8b 5d 08             	mov    0x8(%ebp),%ebx
	// file descriptor.
  ...
  800ed5:	53                   	push   %ebx
  800ed6:	e8 63 f2 ff ff       	call   80013e <strlen>
  800edb:	83 c4 10             	add    $0x10,%esp
  800ede:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  800ee3:	7f 67                	jg     800f4c <open+0x81>
		return -E_BAD_PATH;
  ...
  800eeb:	50                   	push   %eax
  800eec:	e8 a1 f8 ff ff       	call   800792 <fd_alloc>
...
//cprintf("lib/file.c/open():after to user fsipc().\n");
  ...
  800f4a:	eb 05                	jmp    800f51 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  800f4c:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
//cprintf("lib/file.c/open():after to user fsipc().\n");
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f7d:	e8 f9 f7 ff ff       	call   80077b <fd2data>
  800f82:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  800f84:	83 c4 08             	add    $0x8,%esp
  800f87:	68 77 1f 80 00       	push   $0x801f77
  800f8c:	53                   	push   %ebx
  800f8d:	e8 e5 f1 ff ff       	call   800177 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  800f92:	8b 46 04             	mov    0x4(%esi),%eax
  800f95:	2b 06                	sub    (%esi),%eax
  800f97:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  800f9d:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  800fa4:	00 00 00 
	stat->st_dev = &devpipe;
  800fa7:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  800fae:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  800fca:	e8 30 f6 ff ff       	call   8005ff <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  800fcf:	89 1c 24             	mov    %ebx,(%esp)
  800fd2:	e8 a4 f7 ff ff       	call   80077b <fd2data>
  800fd7:	83 c4 08             	add    $0x8,%esp
  800fda:	50                   	push   %eax
  800fdb:	6a 00                	push   $0x0
  800fdd:	e8 1d f6 ff ff       	call   8005ff <sys_page_unmap>
}
  800fe2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  800fe5:	c9                   	leave  
  800fe6:	c3                   	ret    

00800fe7 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800ffa:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  800ffd:	83 ec 0c             	sub    $0xc,%esp
  801000:	ff 75 e0             	pushl  -0x20(%ebp)
  801003:	e8 8e 0b 00 00       	call   801b96 <pageref>
  801008:	89 c3                	mov    %eax,%ebx
  80100a:	89 3c 24             	mov    %edi,(%esp)
  80100d:	e8 84 0b 00 00       	call   801b96 <pageref>
  801012:	83 c4 10             	add    $0x10,%esp
  801015:	39 c3                	cmp    %eax,%ebx
  801017:	0f 94 c1             	sete   %cl
  80101a:	0f b6 c9             	movzbl %cl,%ecx
  80101d:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801020:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801026:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801029:	39 ce                	cmp    %ecx,%esi
  80102b:	74 1b                	je     801048 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  80102d:	39 c3                	cmp    %eax,%ebx
  80102f:	75 c4                	jne    800ff5 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801031:	8b 42 58             	mov    0x58(%edx),%eax
  801034:	ff 75 e4             	pushl  -0x1c(%ebp)
  801037:	50                   	push   %eax
  801038:	56                   	push   %esi
  801039:	68 7e 1f 80 00       	push   $0x801f7e
  80103e:	e8 e4 04 00 00       	call   801527 <cprintf>
  801043:	83 c4 10             	add    $0x10,%esp
  801046:	eb ad                	jmp    800ff5 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80105f:	56                   	push   %esi
  801060:	e8 16 f7 ff ff       	call   80077b <fd2data>
  ...
  80106f:	eb 4b                	jmp    8010bc <devpipe_write+0x69>
  ...
  801075:	e8 6d ff ff ff       	call   800fe7 <_pipeisclosed>
  80107a:	85 c0                	test   %eax,%eax
  80107c:	75 48                	jne    8010c6 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  80107e:	e8 d8 f4 ff ff       	call   80055b <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801083:	8b 43 04             	mov    0x4(%ebx),%eax
  801086:	8b 0b                	mov    (%ebx),%ecx
  801088:	8d 51 20             	lea    0x20(%ecx),%edx
  80108b:	39 d0                	cmp    %edx,%eax
  80108d:	73 e2                	jae    801071 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801092:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  801096:	88 4d e7             	mov    %cl,-0x19(%ebp)
  801099:	89 c2                	mov    %eax,%edx
  80109b:	c1 fa 1f             	sar    $0x1f,%edx
  80109e:	89 d1                	mov    %edx,%ecx
  8010a0:	c1 e9 1b             	shr    $0x1b,%ecx
  8010a3:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  8010a6:	83 e2 1f             	and    $0x1f,%edx
  8010a9:	29 ca                	sub    %ecx,%edx
  8010ab:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  8010af:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  8010b3:	83 c0 01             	add    $0x1,%eax
  8010b6:	89 43 04             	mov    %eax,0x4(%ebx)
	if (debug)
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  8010b9:	83 c7 01             	add    $0x1,%edi
  8010bc:	3b 7d 10             	cmp    0x10(%ebp),%edi
  8010bf:	75 c2                	jne    801083 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  8010c4:	eb 05                	jmp    8010cb <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010dc:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  8010df:	57                   	push   %edi
  8010e0:	e8 96 f6 ff ff       	call   80077b <fd2data>
  ...
  8010ef:	eb 3d                	jmp    80112e <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  8010f1:	85 db                	test   %ebx,%ebx
  8010f3:	74 04                	je     8010f9 <devpipe_read+0x26>
				return i;
  8010f5:	89 d8                	mov    %ebx,%eax
  8010f7:	eb 44                	jmp    80113d <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  8010f9:	89 f2                	mov    %esi,%edx
  8010fb:	89 f8                	mov    %edi,%eax
  8010fd:	e8 e5 fe ff ff       	call   800fe7 <_pipeisclosed>
  801102:	85 c0                	test   %eax,%eax
  801104:	75 32                	jne    801138 <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801106:	e8 50 f4 ff ff       	call   80055b <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  80110b:	8b 06                	mov    (%esi),%eax
  80110d:	3b 46 04             	cmp    0x4(%esi),%eax
  801110:	74 df                	je     8010f1 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801118:	83 e0 1f             	and    $0x1f,%eax
  80111b:	29 d0                	sub    %edx,%eax
  80111d:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801122:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801125:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  801128:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  80112e:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801131:	75 d8                	jne    80110b <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801136:	eb 05                	jmp    80113d <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  801265:	e8 95 f3 ff ff       	call   8005ff <sys_page_unmap>
  ...
  801275:	e8 85 f3 ff ff       	call   8005ff <sys_page_unmap>
  ...
  801285:	e8 75 f3 ff ff       	call   8005ff <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  8012a5:	e8 37 f5 ff ff       	call   8007e1 <fd_lookup>
  8012aa:	83 c4 10             	add    $0x10,%esp
  8012ad:	85 c0                	test   %eax,%eax
  8012af:	78 18                	js     8012c9 <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  8012b1:	83 ec 0c             	sub    $0xc,%esp
  8012b4:	ff 75 f4             	pushl  -0xc(%ebp)
  8012b7:	e8 bf f4 ff ff       	call   80077b <fd2data>
	return _pipeisclosed(fd, p);
  8012bc:	89 c2                	mov    %eax,%edx
  8012be:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8012c1:	e8 21 fd ff ff       	call   800fe7 <_pipeisclosed>
  8012c6:	83 c4 10             	add    $0x10,%esp
}
  8012c9:	c9                   	leave  
  8012ca:	c3                   	ret    

008012cb <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8012db:	68 96 1f 80 00       	push   $0x801f96
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801300:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801306:	eb 2d                	jmp    801335 <devcons_write+0x46>
		m = n - tot;
  801308:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80130b:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  80130d:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801310:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801315:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  80131f:	50                   	push   %eax
  801320:	57                   	push   %edi
  801321:	e8 e3 ef ff ff       	call   800309 <memmove>
		sys_cputs(buf, m);
  801326:	83 c4 08             	add    $0x8,%esp
  801329:	53                   	push   %ebx
  80132a:	57                   	push   %edi
  80132b:	e8 8e f1 ff ff       	call   8004be <sys_cputs>
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801330:	01 de                	add    %ebx,%esi
  801332:	83 c4 10             	add    $0x10,%esp
  801335:	89 f0                	mov    %esi,%eax
  801337:	3b 75 10             	cmp    0x10(%ebp),%esi
  80133a:	72 cc                	jb     801308 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801353:	74 2a                	je     80137f <devcons_read+0x3b>
  801355:	eb 05                	jmp    80135c <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801357:	e8 ff f1 ff ff       	call   80055b <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  80135c:	e8 7b f1 ff ff       	call   8004dc <sys_cgetc>
  801361:	85 c0                	test   %eax,%eax
  801363:	74 f2                	je     801357 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801365:	85 c0                	test   %eax,%eax
  801367:	78 16                	js     80137f <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801369:	83 f8 04             	cmp    $0x4,%eax
  80136c:	74 0c                	je     80137a <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  80136e:	8b 55 0c             	mov    0xc(%ebp),%edx
  801371:	88 02                	mov    %al,(%edx)
	return 1;
  801373:	b8 01 00 00 00       	mov    $0x1,%eax
  801378:	eb 05                	jmp    80137f <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  80138a:	88 45 f7             	mov    %al,-0x9(%ebp)

	// Unlike standard Unix's putchar,
	// the cputchar function _always_ outputs to the system console.
	sys_cputs(&c, 1);
  80138d:	6a 01                	push   $0x1
  80138f:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801392:	50                   	push   %eax
  801393:	e8 26 f1 ff ff       	call   8004be <sys_cputs>
}
...
getchar(void)
{
  ...
  8013a5:	8d 45 f7             	lea    -0x9(%ebp),%eax
  8013a8:	50                   	push   %eax
  8013a9:	6a 00                	push   $0x0
  8013ab:	e8 97 f6 ff ff       	call   800a47 <read>
	if (r < 0)
  8013b0:	83 c4 10             	add    $0x10,%esp
  8013b3:	85 c0                	test   %eax,%eax
  8013b5:	78 0f                	js     8013c6 <getchar+0x29>
		return r;
	if (r < 1)
  8013b7:	85 c0                	test   %eax,%eax
  8013b9:	7e 06                	jle    8013c1 <getchar+0x24>
		return -E_EOF;
	return c;
  8013bb:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  8013bf:	eb 05                	jmp    8013c6 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  8013c1:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  8013c6:	c9                   	leave  
  8013c7:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  8013d5:	e8 07 f4 ff ff       	call   8007e1 <fd_lookup>
  8013da:	83 c4 10             	add    $0x10,%esp
  8013dd:	85 c0                	test   %eax,%eax
  8013df:	78 11                	js     8013f2 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  8013e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8013e4:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  8013ea:	39 10                	cmp    %edx,(%eax)
  8013ec:	0f 94 c0             	sete   %al
  8013ef:	0f b6 c0             	movzbl %al,%eax
}
  8013f2:	c9                   	leave  
  8013f3:	c3                   	ret    
...
opencons(void)
{
  ...
  8013fd:	50                   	push   %eax
  8013fe:	e8 8f f3 ff ff       	call   800792 <fd_alloc>
...
opencons(void)
{
  ...
  80140a:	78 3e                	js     80144a <opencons+0x56>
		return r;
	if ((r = sys_page_alloc(0, fd, PTE_P|PTE_U|PTE_W|PTE_SHARE)) < 0)
  80140c:	83 ec 04             	sub    $0x4,%esp
  80140f:	68 07 04 00 00       	push   $0x407
  801414:	ff 75 f4             	pushl  -0xc(%ebp)
  801417:	6a 00                	push   $0x0
  801419:	e8 5c f1 ff ff       	call   80057a <sys_page_alloc>
  ...
  801425:	78 23                	js     80144a <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  801427:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  80142d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801430:	89 10                	mov    %edx,(%eax)
	fd->fd_omode = O_RDWR;
  801432:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801435:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  80143c:	83 ec 0c             	sub    $0xc,%esp
  80143f:	50                   	push   %eax
  801440:	e8 26 f3 ff ff       	call   80076b <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80145c:	e8 db f0 ff ff       	call   80053c <sys_getenvid>
  801461:	83 ec 0c             	sub    $0xc,%esp
  801464:	ff 75 0c             	pushl  0xc(%ebp)
  801467:	ff 75 08             	pushl  0x8(%ebp)
  80146a:	56                   	push   %esi
  80146b:	50                   	push   %eax
  80146c:	68 a4 1f 80 00       	push   $0x801fa4
  801471:	e8 b1 00 00 00       	call   801527 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801476:	83 c4 18             	add    $0x18,%esp
  801479:	53                   	push   %ebx
  80147a:	ff 75 10             	pushl  0x10(%ebp)
  80147d:	e8 54 00 00 00       	call   8014d6 <vcprintf>
	cprintf("\n");
  801482:	c7 04 24 8f 1f 80 00 	movl   $0x801f8f,(%esp)
  801489:	e8 99 00 00 00       	call   801527 <cprintf>
...
putch(int ch, struct printbuf *b)
{
  ...
  8014b1:	75 1a                	jne    8014cd <putch+0x39>
		sys_cputs(b->buf, b->idx);
  8014b3:	83 ec 08             	sub    $0x8,%esp
  8014b6:	68 ff 00 00 00       	push   $0xff
  8014bb:	8d 43 08             	lea    0x8(%ebx),%eax
  8014be:	50                   	push   %eax
  8014bf:	e8 fa ef ff ff       	call   8004be <sys_cputs>
		b->idx = 0;
  8014c4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8014ca:	83 c4 10             	add    $0x10,%esp
	}
	b->cnt++;
  8014cd:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8014d9:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	
	b.idx = 0;
  8014df:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  8014e6:	00 00 00 
	b.cnt = 0;
  8014e9:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  8014f0:	00 00 00 
	vprintfmt((void*)putch, &b, fmt, ap);
  8014f3:	ff 75 0c             	pushl  0xc(%ebp)
  8014f6:	ff 75 08             	pushl  0x8(%ebp)
  8014f9:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  8014ff:	50                   	push   %eax
  801500:	68 94 14 80 00       	push   $0x801494
  801505:	e8 54 01 00 00       	call   80165e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  80150a:	83 c4 08             	add    $0x8,%esp
  80150d:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
  801513:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  801519:	50                   	push   %eax
  80151a:	e8 9f ef ff ff       	call   8004be <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  801534:	e8 9d ff ff ff       	call   8014d6 <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801551:	89 55 dc             	mov    %edx,-0x24(%ebp)
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
  801554:	8b 4d 10             	mov    0x10(%ebp),%ecx
  801557:	bb 00 00 00 00       	mov    $0x0,%ebx
  80155c:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  80155f:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  801562:	39 d3                	cmp    %edx,%ebx
  801564:	72 05                	jb     80156b <printnum+0x30>
  801566:	39 45 10             	cmp    %eax,0x10(%ebp)
  801569:	77 45                	ja     8015b0 <printnum+0x75>
		printnum(putch, putdat, num / base, base, width - 1, padc);
  80156b:	83 ec 0c             	sub    $0xc,%esp
  80156e:	ff 75 18             	pushl  0x18(%ebp)
  801571:	8b 45 14             	mov    0x14(%ebp),%eax
  801574:	8d 58 ff             	lea    -0x1(%eax),%ebx
  801577:	53                   	push   %ebx
  801578:	ff 75 10             	pushl  0x10(%ebp)
  80157b:	83 ec 08             	sub    $0x8,%esp
  80157e:	ff 75 e4             	pushl  -0x1c(%ebp)
  801581:	ff 75 e0             	pushl  -0x20(%ebp)
  801584:	ff 75 dc             	pushl  -0x24(%ebp)
  801587:	ff 75 d8             	pushl  -0x28(%ebp)
  80158a:	e8 51 06 00 00       	call   801be0 <__udivdi3>
  80158f:	83 c4 18             	add    $0x18,%esp
  801592:	52                   	push   %edx
  801593:	50                   	push   %eax
  801594:	89 f2                	mov    %esi,%edx
  801596:	89 f8                	mov    %edi,%eax
  801598:	e8 9e ff ff ff       	call   80153b <printnum>
  80159d:	83 c4 20             	add    $0x20,%esp
  8015a0:	eb 18                	jmp    8015ba <printnum+0x7f>
	} else {
  ...
  8015a5:	56                   	push   %esi
  8015a6:	ff 75 18             	pushl  0x18(%ebp)
  8015a9:	ff d7                	call   *%edi
  8015ab:	83 c4 10             	add    $0x10,%esp
  8015ae:	eb 03                	jmp    8015b3 <printnum+0x78>
  8015b0:	8b 5d 14             	mov    0x14(%ebp),%ebx
	...
	if (num >= base) {
		...
		// print any needed pad characters before first digit
		while (--width > 0)
  8015b3:	83 eb 01             	sub    $0x1,%ebx
  8015b6:	85 db                	test   %ebx,%ebx
  8015b8:	7f e8                	jg     8015a2 <printnum+0x67>
			putch(padc, putdat);
	}
  ...
  8015c7:	ff 75 dc             	pushl  -0x24(%ebp)
  8015ca:	ff 75 d8             	pushl  -0x28(%ebp)
  8015cd:	e8 3e 07 00 00       	call   801d10 <__umoddi3>
  8015d2:	83 c4 14             	add    $0x14,%esp
  8015d5:	0f be 80 c7 1f 80 00 	movsbl 0x801fc7(%eax),%eax
  8015dc:	50                   	push   %eax
  8015dd:	ff d7                	call   *%edi
}
...
getuint(va_list *ap, int lflag)
{
  ...
  8015eb:	89 e5                	mov    %esp,%ebp
	if (lflag >= 2)
  8015ed:	83 fa 01             	cmp    $0x1,%edx
  8015f0:	7e 0e                	jle    801600 <getuint+0x16>
		return va_arg(*ap, unsigned long long);
  8015f2:	8b 10                	mov    (%eax),%edx
  8015f4:	8d 4a 08             	lea    0x8(%edx),%ecx
  8015f7:	89 08                	mov    %ecx,(%eax)
  8015f9:	8b 02                	mov    (%edx),%eax
  8015fb:	8b 52 04             	mov    0x4(%edx),%edx
  8015fe:	eb 22                	jmp    801622 <getuint+0x38>
	else if (lflag)
  801600:	85 d2                	test   %edx,%edx
  801602:	74 10                	je     801614 <getuint+0x2a>
  ...
  801612:	eb 0e                	jmp    801622 <getuint+0x38>
	else
		return va_arg(*ap, unsigned int);
  801614:	8b 10                	mov    (%eax),%edx
  801616:	8d 4a 04             	lea    0x4(%edx),%ecx
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801670:	eb 12                	jmp    801684 <vprintfmt+0x26>
  ...
  801674:	0f 84 d3 03 00 00    	je     801a4d <vprintfmt+0x3ef>
				return;
			putch(ch, putdat);
  80167a:	83 ec 08             	sub    $0x8,%esp
  80167d:	53                   	push   %ebx
  80167e:	50                   	push   %eax
  80167f:	ff d6                	call   *%esi
  ...
  801687:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
  80168b:	83 f8 25             	cmp    $0x25,%eax
  80168e:	75 e2                	jne    801672 <vprintfmt+0x14>
  801690:	c6 45 d4 20          	movb   $0x20,-0x2c(%ebp)
  801694:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
  80169b:	c7 45 c8 ff ff ff ff 	movl   $0xffffffff,-0x38(%ebp)
  8016a2:	c7 45 e0 ff ff ff ff 	movl   $0xffffffff,-0x20(%ebp)
  8016a9:	ba 00 00 00 00       	mov    $0x0,%edx
  8016ae:	eb 07                	jmp    8016b7 <vprintfmt+0x59>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
  ...
  8016b3:	c6 45 d4 2d          	movb   $0x2d,-0x2c(%ebp)
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
  8016b7:	8d 47 01             	lea    0x1(%edi),%eax
  8016ba:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8016bd:	0f b6 07             	movzbl (%edi),%eax
  8016c0:	0f b6 c8             	movzbl %al,%ecx
  8016c3:	83 e8 23             	sub    $0x23,%eax
  8016c6:	3c 55                	cmp    $0x55,%al
  8016c8:	0f 87 64 03 00 00    	ja     801a32 <vprintfmt+0x3d4>
  8016ce:	0f b6 c0             	movzbl %al,%eax
  8016d1:	ff 24 85 00 21 80 00 	jmp    *0x802100(,%eax,4)
  8016d8:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			padc = '-';
			goto reswitch;
		...
		case '0':
			padc = '0';
  8016db:	c6 45 d4 30          	movb   $0x30,-0x2c(%ebp)
  8016df:	eb d6                	jmp    8016b7 <vprintfmt+0x59>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
  ...
  8016ec:	8d 04 80             	lea    (%eax,%eax,4),%eax
  8016ef:	8d 44 41 d0          	lea    -0x30(%ecx,%eax,2),%eax
				ch = *fmt;
  8016f3:	0f be 0f             	movsbl (%edi),%ecx
				if (ch < '0' || ch > '9')
  8016f6:	8d 51 d0             	lea    -0x30(%ecx),%edx
  8016f9:	83 fa 09             	cmp    $0x9,%edx
  8016fc:	77 39                	ja     801737 <vprintfmt+0xd9>
		case '5':
		case '6':
		case '7':
		case '8':
  ...
  801701:	eb e9                	jmp    8016ec <vprintfmt+0x8e>
			goto process_precision;

		case '*':
			precision = va_arg(ap, int);
  801703:	8b 45 14             	mov    0x14(%ebp),%eax
  801706:	8d 48 04             	lea    0x4(%eax),%ecx
  801709:	89 4d 14             	mov    %ecx,0x14(%ebp)
  80170c:	8b 00                	mov    (%eax),%eax
  80170e:	89 45 c8             	mov    %eax,-0x38(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
  ...
  801711:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '*':
			precision = va_arg(ap, int);
			goto process_precision;
  801714:	eb 27                	jmp    80173d <vprintfmt+0xdf>
  801716:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801719:	85 c0                	test   %eax,%eax
  80171b:	b9 00 00 00 00       	mov    $0x0,%ecx
  801720:	0f 49 c8             	cmovns %eax,%ecx
  801723:	89 4d e0             	mov    %ecx,-0x20(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
  ...
  801729:	eb 8c                	jmp    8016b7 <vprintfmt+0x59>
  80172b:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '#':
			altflag = 1;
  80172e:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
			goto reswitch;
  801735:	eb 80                	jmp    8016b7 <vprintfmt+0x59>
  ...
  801741:	0f 89 70 ff ff ff    	jns    8016b7 <vprintfmt+0x59>
				width = precision, precision = -1;
  801747:	8b 45 c8             	mov    -0x38(%ebp),%eax
  80174a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  80174d:	c7 45 c8 ff ff ff ff 	movl   $0xffffffff,-0x38(%ebp)
  801754:	e9 5e ff ff ff       	jmp    8016b7 <vprintfmt+0x59>
			goto reswitch;
  ...
  80175c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'l':
			lflag++;
			goto reswitch;
  80175f:	e9 53 ff ff ff       	jmp    8016b7 <vprintfmt+0x59>
  ...
  801778:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'c':
			putch(va_arg(ap, int), putdat);
			break;
  80177b:	e9 04 ff ff ff       	jmp    801684 <vprintfmt+0x26>

		// error message
		case 'e':
			err = va_arg(ap, int);
  801780:	8b 45 14             	mov    0x14(%ebp),%eax
  801783:	8d 50 04             	lea    0x4(%eax),%edx
  801786:	89 55 14             	mov    %edx,0x14(%ebp)
  801789:	8b 00                	mov    (%eax),%eax
  80178b:	99                   	cltd   
  80178c:	31 d0                	xor    %edx,%eax
  80178e:	29 d0                	sub    %edx,%eax
			if (err < 0)
				err = -err;
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
  801790:	83 f8 0f             	cmp    $0xf,%eax
  801793:	7f 0b                	jg     8017a0 <vprintfmt+0x142>
  801795:	8b 14 85 60 22 80 00 	mov    0x802260(,%eax,4),%edx
  80179c:	85 d2                	test   %edx,%edx
  80179e:	75 18                	jne    8017b8 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8017a0:	50                   	push   %eax
  8017a1:	68 df 1f 80 00       	push   $0x801fdf
  8017a6:	53                   	push   %ebx
  8017a7:	56                   	push   %esi
  8017a8:	e8 94 fe ff ff       	call   801641 <printfmt>
  ...
  8017b0:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'e':
			...
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
				printfmt(putch, putdat, "error %d", err);
  8017b3:	e9 cc fe ff ff       	jmp    801684 <vprintfmt+0x26>
			else
				printfmt(putch, putdat, "%s", p);
  8017b8:	52                   	push   %edx
  8017b9:	68 5d 1f 80 00       	push   $0x801f5d
  8017be:	53                   	push   %ebx
  8017bf:	56                   	push   %esi
  8017c0:	e8 7c fe ff ff       	call   801641 <printfmt>
  ...
  8017cb:	e9 b4 fe ff ff       	jmp    801684 <vprintfmt+0x26>
				printfmt(putch, putdat, "%s", p);
			break;
  ...
  8017d9:	8b 38                	mov    (%eax),%edi
				p = "(null)";
  8017db:	85 ff                	test   %edi,%edi
  8017dd:	b8 d8 1f 80 00       	mov    $0x801fd8,%eax
  8017e2:	0f 44 f8             	cmove  %eax,%edi
			if (width > 0 && padc != '-')
  8017e5:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8017e9:	0f 8e 94 00 00 00    	jle    801883 <vprintfmt+0x225>
  8017ef:	80 7d d4 2d          	cmpb   $0x2d,-0x2c(%ebp)
  8017f3:	0f 84 98 00 00 00    	je     801891 <vprintfmt+0x233>
				for (width -= strnlen(p, precision); width > 0; width--)
  8017f9:	83 ec 08             	sub    $0x8,%esp
  8017fc:	ff 75 c8             	pushl  -0x38(%ebp)
  8017ff:	57                   	push   %edi
  801800:	e8 51 e9 ff ff       	call   800156 <strnlen>
  801805:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  801808:	29 c1                	sub    %eax,%ecx
  80180a:	89 4d d0             	mov    %ecx,-0x30(%ebp)
  80180d:	83 c4 10             	add    $0x10,%esp
					putch(padc, putdat);
  801810:	0f be 45 d4          	movsbl -0x2c(%ebp),%eax
  801814:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801817:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  80181a:	89 cf                	mov    %ecx,%edi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
  80181c:	eb 0f                	jmp    80182d <vprintfmt+0x1cf>
					putch(padc, putdat);
  80181e:	83 ec 08             	sub    $0x8,%esp
  801821:	53                   	push   %ebx
  801822:	ff 75 e0             	pushl  -0x20(%ebp)
  801825:	ff d6                	call   *%esi
		...
		case 's':
			...
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
  801827:	83 ef 01             	sub    $0x1,%edi
  80182a:	83 c4 10             	add    $0x10,%esp
  80182d:	85 ff                	test   %edi,%edi
  80182f:	7f ed                	jg     80181e <vprintfmt+0x1c0>
  801831:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  801834:	8b 4d d0             	mov    -0x30(%ebp),%ecx
  801837:	85 c9                	test   %ecx,%ecx
  801839:	b8 00 00 00 00       	mov    $0x0,%eax
  80183e:	0f 49 c1             	cmovns %ecx,%eax
  801841:	29 c1                	sub    %eax,%ecx
  801843:	89 75 08             	mov    %esi,0x8(%ebp)
  801846:	8b 75 c8             	mov    -0x38(%ebp),%esi
  801849:	89 5d 0c             	mov    %ebx,0xc(%ebp)
  80184c:	89 cb                	mov    %ecx,%ebx
  80184e:	eb 4d                	jmp    80189d <vprintfmt+0x23f>
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
  801850:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  801854:	74 1b                	je     801871 <vprintfmt+0x213>
  801856:	0f be c0             	movsbl %al,%eax
  801859:	83 e8 20             	sub    $0x20,%eax
  80185c:	83 f8 5e             	cmp    $0x5e,%eax
  80185f:	76 10                	jbe    801871 <vprintfmt+0x213>
					putch('?', putdat);
  801861:	83 ec 08             	sub    $0x8,%esp
  801864:	ff 75 0c             	pushl  0xc(%ebp)
  801867:	6a 3f                	push   $0x3f
  801869:	ff 55 08             	call   *0x8(%ebp)
  80186c:	83 c4 10             	add    $0x10,%esp
  80186f:	eb 0d                	jmp    80187e <vprintfmt+0x220>
				else
					putch(ch, putdat);
  801871:	83 ec 08             	sub    $0x8,%esp
  801874:	ff 75 0c             	pushl  0xc(%ebp)
  801877:	52                   	push   %edx
  801878:	ff 55 08             	call   *0x8(%ebp)
  80187b:	83 c4 10             	add    $0x10,%esp
			...
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
  80187e:	83 eb 01             	sub    $0x1,%ebx
  801881:	eb 1a                	jmp    80189d <vprintfmt+0x23f>
  801883:	89 75 08             	mov    %esi,0x8(%ebp)
  801886:	8b 75 c8             	mov    -0x38(%ebp),%esi
  801889:	89 5d 0c             	mov    %ebx,0xc(%ebp)
  80188c:	8b 5d e0             	mov    -0x20(%ebp),%ebx
  80188f:	eb 0c                	jmp    80189d <vprintfmt+0x23f>
  801891:	89 75 08             	mov    %esi,0x8(%ebp)
  801894:	8b 75 c8             	mov    -0x38(%ebp),%esi
  801897:	89 5d 0c             	mov    %ebx,0xc(%ebp)
  80189a:	8b 5d e0             	mov    -0x20(%ebp),%ebx
  80189d:	83 c7 01             	add    $0x1,%edi
  8018a0:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
  8018a4:	0f be d0             	movsbl %al,%edx
  8018a7:	85 d2                	test   %edx,%edx
  8018a9:	74 23                	je     8018ce <vprintfmt+0x270>
  8018ab:	85 f6                	test   %esi,%esi
  8018ad:	78 a1                	js     801850 <vprintfmt+0x1f2>
  8018af:	83 ee 01             	sub    $0x1,%esi
  8018b2:	79 9c                	jns    801850 <vprintfmt+0x1f2>
  8018b4:	89 df                	mov    %ebx,%edi
  8018b6:	8b 75 08             	mov    0x8(%ebp),%esi
  8018b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  8018bc:	eb 18                	jmp    8018d6 <vprintfmt+0x278>
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
  ...
  8018d8:	7f e4                	jg     8018be <vprintfmt+0x260>
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
  8018da:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  8018dd:	e9 a2 fd ff ff       	jmp    801684 <vprintfmt+0x26>
...
{
	if (lflag >= 2)
  8018e2:	83 fa 01             	cmp    $0x1,%edx
  8018e5:	7e 16                	jle    8018fd <vprintfmt+0x29f>
		return va_arg(*ap, long long);
  8018e7:	8b 45 14             	mov    0x14(%ebp),%eax
  8018ea:	8d 50 08             	lea    0x8(%eax),%edx
  8018ed:	89 55 14             	mov    %edx,0x14(%ebp)
  8018f0:	8b 50 04             	mov    0x4(%eax),%edx
  8018f3:	8b 00                	mov    (%eax),%eax
  8018f5:	89 45 c8             	mov    %eax,-0x38(%ebp)
  8018f8:	89 55 cc             	mov    %edx,-0x34(%ebp)
  8018fb:	eb 32                	jmp    80192f <vprintfmt+0x2d1>
	else if (lflag)
  8018fd:	85 d2                	test   %edx,%edx
  8018ff:	74 18                	je     801919 <vprintfmt+0x2bb>
  ...
  80190c:	89 45 c8             	mov    %eax,-0x38(%ebp)
  80190f:	89 c1                	mov    %eax,%ecx
  801911:	c1 f9 1f             	sar    $0x1f,%ecx
  801914:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  801917:	eb 16                	jmp    80192f <vprintfmt+0x2d1>
	else
  ...
  801924:	89 45 c8             	mov    %eax,-0x38(%ebp)
  801927:	89 c1                	mov    %eax,%ecx
  801929:	c1 f9 1f             	sar    $0x1f,%ecx
  80192c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
				putch(' ', putdat);
			break;
		...
		case 'd':
			num = getint(&ap, lflag);
  80192f:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801932:	8b 55 cc             	mov    -0x34(%ebp),%edx
  ...
  80193b:	b8 0a 00 00 00       	mov    $0xa,%eax
		...
		case 'd':
			num = getint(&ap, lflag);
			if ((long long) num < 0) {
  801940:	83 7d cc 00          	cmpl   $0x0,-0x34(%ebp)
  801944:	0f 89 b0 00 00 00    	jns    8019fa <vprintfmt+0x39c>
				putch('-', putdat);
  80194a:	83 ec 08             	sub    $0x8,%esp
  80194d:	53                   	push   %ebx
  80194e:	6a 2d                	push   $0x2d
  801950:	ff d6                	call   *%esi
				num = -(long long) num;
  801952:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801955:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801958:	f7 d8                	neg    %eax
  80195a:	83 d2 00             	adc    $0x0,%edx
  80195d:	f7 da                	neg    %edx
  80195f:	89 45 d8             	mov    %eax,-0x28(%ebp)
  801962:	89 55 dc             	mov    %edx,-0x24(%ebp)
  801965:	83 c4 10             	add    $0x10,%esp
			}
			base = 10;
  801968:	b8 0a 00 00 00       	mov    $0xa,%eax
  80196d:	e9 88 00 00 00       	jmp    8019fa <vprintfmt+0x39c>
			goto number;
  ...
  801975:	e8 70 fc ff ff       	call   8015ea <getuint>
  80197a:	89 45 d8             	mov    %eax,-0x28(%ebp)
  80197d:	89 55 dc             	mov    %edx,-0x24(%ebp)
			base = 10;
  801980:	b8 0a 00 00 00       	mov    $0xa,%eax
			goto number;
  801985:	eb 73                	jmp    8019fa <vprintfmt+0x39c>
		// (unsigned) octal
		case 'o':
  ...
  80198a:	e8 5b fc ff ff       	call   8015ea <getuint>
  ...
  8019b0:	b8 08 00 00 00       	mov    $0x8,%eax
			...
			putch('X', putdat);
			goto number;
  8019b5:	eb 43                	jmp    8019fa <vprintfmt+0x39c>
			break;
  ...
  8019da:	89 55 dc             	mov    %edx,-0x24(%ebp)
				(uintptr_t) va_arg(ap, void *);
			base = 16;
			goto number;
  8019dd:	83 c4 10             	add    $0x10,%esp
		case 'p':
			...
			num = (unsigned long long)
				(uintptr_t) va_arg(ap, void *);
			base = 16;
  8019e0:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8019e5:	eb 13                	jmp    8019fa <vprintfmt+0x39c>

		// (unsigned) hexadecimal
		case 'x':
			num = getuint(&ap, lflag);
  8019e7:	8d 45 14             	lea    0x14(%ebp),%eax
  8019ea:	e8 fb fb ff ff       	call   8015ea <getuint>
  8019ef:	89 45 d8             	mov    %eax,-0x28(%ebp)
  8019f2:	89 55 dc             	mov    %edx,-0x24(%ebp)
			base = 16;
  8019f5:	b8 10 00 00 00       	mov    $0x10,%eax
		number:
			printnum(putch, putdat, num, base, width, padc);
  8019fa:	83 ec 0c             	sub    $0xc,%esp
  8019fd:	0f be 55 d4          	movsbl -0x2c(%ebp),%edx
  801a01:	52                   	push   %edx
  801a02:	ff 75 e0             	pushl  -0x20(%ebp)
  801a05:	50                   	push   %eax
  801a06:	ff 75 dc             	pushl  -0x24(%ebp)
  801a09:	ff 75 d8             	pushl  -0x28(%ebp)
  801a0c:	89 da                	mov    %ebx,%edx
  801a0e:	89 f0                	mov    %esi,%eax
  801a10:	e8 26 fb ff ff       	call   80153b <printnum>
			break;
  801a15:	83 c4 20             	add    $0x20,%esp
  801a18:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  801a1b:	e9 64 fc ff ff       	jmp    801684 <vprintfmt+0x26>
  ...
  801a2a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '%':
			putch(ch, putdat);
			break;
  801a2d:	e9 52 fc ff ff       	jmp    801684 <vprintfmt+0x26>
  ...
  801a3d:	eb 03                	jmp    801a42 <vprintfmt+0x3e4>
  801a3f:	83 ef 01             	sub    $0x1,%edi
  801a42:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
  801a46:	75 f7                	jne    801a3f <vprintfmt+0x3e1>
  801a48:	e9 37 fc ff ff       	jmp    801684 <vprintfmt+0x26>
				/* do nothing */;
			break;
		}
	}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  801a61:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801a64:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
  801a68:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  801a6b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
  801a72:	85 c0                	test   %eax,%eax
  801a74:	74 26                	je     801a9c <vsnprintf+0x47>
  801a76:	85 d2                	test   %edx,%edx
  801a78:	7e 22                	jle    801a9c <vsnprintf+0x47>
		return -E_INVAL;
  ...
  801a80:	8d 45 ec             	lea    -0x14(%ebp),%eax
  801a83:	50                   	push   %eax
  801a84:	68 24 16 80 00       	push   $0x801624
  801a89:	e8 d0 fb ff ff       	call   80165e <vprintfmt>
  ...
  801a9a:	eb 05                	jmp    801aa1 <vsnprintf+0x4c>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  801ab6:	e8 9a ff ff ff       	call   801a55 <vsnprintf>
	va_end(ap);
...
//	cprintf("sys_ipc_recv(pg) done.\n");	
  ...
  801afb:	8b 50 74             	mov    0x74(%eax),%edx
  801afe:	85 d2                	test   %edx,%edx
  801b00:	74 e4                	je     801ae6 <ipc_recv+0x29>
		cprintf("recv waitting. ");//*from_env_store = thisenv->env_ipc_from;
	}	
	if(from_env_store != NULL){
  801b02:	85 db                	test   %ebx,%ebx
  801b04:	74 05                	je     801b0b <ipc_recv+0x4e>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b26:	8b 75 0c             	mov    0xc(%ebp),%esi
...
//		cprintf("sending.");		
  ...
  801b2e:	75 13                	jne    801b43 <ipc_send+0x29>
			retv = sys_ipc_try_send(to_env, val, (void*)UTOP, 0);
  801b30:	6a 00                	push   $0x0
  801b32:	68 00 00 c0 ee       	push   $0xeec00000
  801b37:	56                   	push   %esi
  801b38:	57                   	push   %edi
  801b39:	e8 c9 eb ff ff       	call   800707 <sys_ipc_try_send>
  801b3e:	83 c4 10             	add    $0x10,%esp
  801b41:	eb 0e                	jmp    801b51 <ipc_send+0x37>
		}else{
  ...
  801b47:	56                   	push   %esi
  801b48:	57                   	push   %edi
  801b49:	e8 b9 eb ff ff       	call   800707 <sys_ipc_try_send>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b53:	75 d7                	jne    801b2c <ipc_send+0x12>
...
ipc_find_env(enum EnvType type)
{
  ...
  801b88:	3d 00 04 00 00       	cmp    $0x400,%eax
  801b8d:	75 d9                	jne    801b68 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
