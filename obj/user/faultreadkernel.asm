...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002e3:	ff 24 85 a0 10 80 00 	jmp    *0x8010a0(,%eax,4)
  ...
  8003a7:	8b 14 85 00 12 80 00 	mov    0x801200(,%eax,4),%edx
  8003ae:	85 d2                	test   %edx,%edx
  8003b0:	75 18                	jne    8003ca <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003b2:	50                   	push   %eax
  8003b3:	68 e9 0f 80 00       	push   $0x800fe9
  8003b8:	53                   	push   %ebx
  8003b9:	56                   	push   %esi
  ...
  8003ca:	52                   	push   %edx
  8003cb:	68 f2 0f 80 00       	push   $0x800ff2
  8003d0:	53                   	push   %ebx
  8003d1:	56                   	push   %esi
  ...
  8003ef:	b8 e2 0f 80 00       	mov    $0x800fe2,%eax
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800ab4:	68 24 12 80 00       	push   $0x801224
  800ab9:	6a 23                	push   $0x23
  800abb:	68 41 12 80 00       	push   $0x801241
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800b35:	68 24 12 80 00       	push   $0x801224
  800b3a:	6a 23                	push   $0x23
  800b3c:	68 41 12 80 00       	push   $0x801241
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800b77:	68 24 12 80 00       	push   $0x801224
  800b7c:	6a 23                	push   $0x23
  800b7e:	68 41 12 80 00       	push   $0x801241
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800bb9:	68 24 12 80 00       	push   $0x801224
  800bbe:	6a 23                	push   $0x23
  800bc0:	68 41 12 80 00       	push   $0x801241
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800bfb:	68 24 12 80 00       	push   $0x801224
  800c00:	6a 23                	push   $0x23
  800c02:	68 41 12 80 00       	push   $0x801241
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800c3d:	68 24 12 80 00       	push   $0x801224
  800c42:	6a 23                	push   $0x23
  800c44:	68 41 12 80 00       	push   $0x801241
...
//	panic("SYSCALL: %d\n",a1);
  ...
  800ca1:	68 24 12 80 00       	push   $0x801224
  800ca6:	6a 23                	push   $0x23
  800ca8:	68 41 12 80 00       	push   $0x801241
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cd6:	56                   	push   %esi
  800cd7:	50                   	push   %eax
  800cd8:	68 50 12 80 00       	push   $0x801250
  ...
  800ce9:	e8 fa f3 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800cee:	c7 04 24 74 12 80 00 	movl   $0x801274,(%esp)
